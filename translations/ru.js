...
// Special thanks to @Dimars 

msgCmdHidePowLogON:`Вам не будут показываться посты за которые вы не смогли проголосовать`,
msgCmdHidePowLogOFF:`Бот будет присылать посты за которые он не проголосовал из установленного вами лимита силы. Вы сможете видеть их и голосать вручную.`,
msgCmdChangeVON:
`<b>Включен режим смены голоса за куратором</b>
Если вы проголосовали до куратора силой менее 90% куратор сможет перебить ваш голос на свой вес если он больше чем 10%`,

msgCmdChangeVOFF:`Кураторы не смогут менять ваш вес после того как вы проголосуете`,
msgCmdPowCopyON:
`Вы активировали режим копирования веса голоса куратора
В этом режиме во время повтора голоса за кураторам вы будете голосовать с той силой, с которой проголосовал куратор`,

msgCmdPowCopyOFF:`Режим копирования веса отключен`,
msgCmdVoteAllON:`Вы активировали режим голосования за все посты.

Внимание! Поскольку на голосе выходит большое количество постов - такой режим быстро расходует вашу силу голоса и не может считаться эффективным. 
Рекомендуется указать запрещенные теги и черный список авторов, чтобы ваше голосование не было потрачено впустую`,
msgCmdVoteAllOFF:`Режим голосования за все посты отключен`,

msgCmdVoteTagON:
`<b>Режим голосования за все посты из выбранной категории включен!</b>
Укажите в настройках разрешенные теги для голосования. Без указания тегов, эта опция не может работать.

Внимание! Поскольку на голосе может выходить большое количество постов под выбранным вами тегом - такой режим может быстро расходовать вашу силу голоса.
Вы можете указать черный список авторов, чтобы ваше голосование не было потрачено впустую`,
msgCmdVoteTagOFF:`Режим голосования за все посты с выбранным тегом отключен`,

msgCmdROON:
`<b>Включен режим "только чтение"</b>
В этом режиме вы можете настроить фильтр и просто получать сообщения с постами, бот не будет голосовать за них автоматически, однако вы можете голосовать за них в ручном режиме используя меню бота

Вы можете импортировать подписки в фавориты (в разделе фаворитов) или настроить избранные теги - и ваша лента будет состоять из постов фаворитов и постов с указанным тегом.
Если у вас настроены кураторы - вы будете видеть то, за что голосуют кураторы.
Также вы можете читать все посты голоса - если включите режим голосования за все посты, при этом будет возможность настроить черный список авторов или запрещенные теги`,
msgCmdROOOF:`Режим "только чтение" отключен. Бот будет голосовать автоматически`,

actionMsgAskSendNewPowValue:`Отправьте число от <b>0</b> до <b>100</b> - с таким весом будет поставлен голос автору.`,
actionMsgAskSendComment:
`⌨️ Напишите ваш комментарий/ответ для _{user}. 

Вы можете использовать markdown разметку:

<b>## Текст</b> - Заголовок h1
<b>### Текст</b> - Заголовок h2
<b>***</b> - Разделитель hr
<b>**Текст**</b> - Жирный текст bold
	
Поддерживаются и другие теги markdown, такие как таблицы, код, курсив и т.д.
Вы так же можете добавить ссылку на изображение в комментарий.
	`,
actionMsgErrNoImportCauseNologin:
`<b>У вас не указан логин в настройках, настройте свой аккаунт, чтобы нам было известно откуда импортировать подписчиков.</b>`,
